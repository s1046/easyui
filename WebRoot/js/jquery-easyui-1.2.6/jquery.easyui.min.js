...
(function($) {
	...
	function _3ab(_3ac, year, _3ad) {
		...
		while (_3b3.length < 7) {
			...
			_3b3.push( [ date.getFullYear(), date.getMonth() + 1,
					date.getDate() ]);
		}
		if (_3b0.length < 6) {
			var _3b4 = _3b3[_3b3.length - 1];
...
(function($) {
	...
	$.fn.slider.parseOptions = function(_7ad) {
		...
		return {
			...
			disabled : (t.attr("disabled") ? true : undefined),
			min : (t.attr("min") == "0" ? 0
					: parseInt(t.attr("min")) || undefined),
			max : (t.attr("max") == "0" ? 0
					: parseInt(t.attr("max")) || undefined),
			step : (t.attr("step") == "0" ? 0
					: parseInt(t.attr("step")) || undefined),
